# Integrated ML tap synthesis project for LIFCL-17-9SG72C.
# This validation top deliberately exposes status/debug ports; synthesis gives
# logic/timing evidence, while map/PAR may report an expected I/O-fit failure.
set root [file normalize [file dirname [info script]]]
set project integrated_ml_tap
