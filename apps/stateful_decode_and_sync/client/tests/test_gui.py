...
try:
    ...
    from stateful_decode_and_sync.gui import create_dashboard_window
    from stateful_decode_and_sync.model import ActiveTarget, AppState, CollectionState, CommandResult, LabelState, ModelState
