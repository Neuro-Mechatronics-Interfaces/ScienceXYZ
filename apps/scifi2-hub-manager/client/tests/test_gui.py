...
try:
    ...
    from scifi2_hub_manager.gui import create_dashboard_window
    from scifi2_hub_manager.model import ActiveTarget, AppState, CollectionState, CommandResult, LabelState, ModelState
