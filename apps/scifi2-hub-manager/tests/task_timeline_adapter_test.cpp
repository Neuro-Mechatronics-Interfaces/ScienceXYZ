...
using scifi2_hub::recording::AdapterRejection;
using scifi2_hub::recording::SampleTaskLabelKind;
using scifi2_hub::recording::TaskTimeline;
using scifi2_hub::recording::TaskTimelineAdapter;
...
TaskTransitionEvent wire_event(std::uint64_t event_sequence,
  ...
  wire.set_protocol_version(scifi2_hub::protocol::kProtocolVersion);
