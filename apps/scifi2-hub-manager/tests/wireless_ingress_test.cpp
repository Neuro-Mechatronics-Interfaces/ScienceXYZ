...
using scifi2_hub::wireless::DiagnosticKind;
using scifi2_hub::wireless::IngressConfig;
using scifi2_hub::wireless::IngressMux;
using scifi2_hub::wireless::MultipartMessage;
using scifi2_hub::wireless::NonblockingReader;
using scifi2_hub::wireless::RationalRate;
using scifi2_hub::wireless::SourceConfig;
...
void test_bounded_queue_and_reject_on_gap_policy() {
  ...
  config.gap_policy = scifi2_hub::wireless::GapPolicy::kRejectSourceOnGap;
