...
using scifi2_hub::wireless::AdapterConfig;
using scifi2_hub::wireless::AdapterDiagnosticKind;
using scifi2_hub::wireless::AffineClockEstimator;
using scifi2_hub::wireless::ClockObservationResult;
using scifi2_hub::wireless::ClockSyncSample;
using scifi2_hub::wireless::FourSourceAdapter;
using scifi2_hub::wireless::FourSourceSimulator;
using scifi2_hub::wireless::FourSourceSimulatorConfig;
using scifi2_hub::wireless::MultiSourceAdapter;
using scifi2_hub::wireless::MultiSourceSimulator;
using scifi2_hub::wireless::MultiSourceSimulatorConfig;
using scifi2_hub::wireless::NormalizedWirelessBatch;
using scifi2_hub::wireless::RationalRate;
using scifi2_hub::wireless::SimulatedSourceConfig;
...
void test_affine_fit_uncertainty_and_reordering() {
  scifi2_hub::wireless::ClockEstimatorConfig config;
