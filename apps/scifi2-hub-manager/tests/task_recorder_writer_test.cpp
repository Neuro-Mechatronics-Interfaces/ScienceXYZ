...
using scifi2_hub::recording::RecordingControlEvent;
using scifi2_hub::recording::RecordingControlKind;
using scifi2_hub::recording::RecordSink;
using scifi2_hub::recording::TaskEventKind;
using scifi2_hub::recording::TaskRecorderHdf5Writer;
using scifi2_hub::recording::TaskTimeline;
using scifi2_hub::recording::TaskTransitionRecord;
using scifi2_hub::recording::kTaskTimelineSchema;
using scifi2_hub::wireless::AffineClockEstimator;
using scifi2_hub::wireless::ClockModel;
...
struct FakeRecordSink : RecordSink {
  struct Snapshot {
    ...
    std::vector<scifi2_hub::recording::TaskInterval> intervals;
    std::vector<scifi2_hub::recording::TimelineDiagnostic> diagnostics;
  ...
  bool write_intervals(
      const std::vector<scifi2_hub::recording::TaskInterval>& intervals) override {
    pending.intervals = intervals;
    return true;
  }
  bool write_diagnostics(
      const std::vector<scifi2_hub::recording::TimelineDiagnostic>& diagnostics)
      override {
