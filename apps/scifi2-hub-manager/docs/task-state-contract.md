...
`scifi2-hub-manager` App. It is separate from pipeline readiness, ML
...
<!-- graphviz:apps/scifi2-hub-manager/docs/task-runtime-lifecycle.dot -->
...
<!-- graphviz:apps/scifi2-hub-manager/docs/task-state-authority-plan.dot -->
