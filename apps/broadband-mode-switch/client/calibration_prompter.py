...
from broadband_mode_switch.client import NdjsonClient, SocketClientError
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Safe broadband-mode-switch calibration prompter")
